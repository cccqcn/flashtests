package
{
	public class Path
	{
		...
		/**optimize path, if direct line exists between two points**/
		...
		/**calculate direct line between two points, return length**/
		...
		/**get best next point based on start and end**/
		...
		/**spread directions based on the center of one direction**/
		...
		/**get direction based on start and end**/
		...
		/**return 8 directions of current index
		 * 0  1  2
		 * 7  i  3
		 * 6  5  4
		 * **/
